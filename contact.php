...
<head>
    ...
    <meta name="KEYWORDS"
          content="web application, phone application, Web app, phone app, website, cms, php, html, html5, css, css3, mysql, seo, web, internet, web development, wordpress, joomla, drupal, e-commerce"/>
    <meta name="description"
          content="we build pretty things for the web, no matter weather it’s phone or desktop. Our services are widely differentiated from creative services to full scale back end web application. We adroit to simulate your imagination in sophisticated bending of the rules and formulate a plan to meet your business requirement."/>
...
<div class="header">
    ...
    <div class="headCont"><img src="images/logo.png" class="logoPrime" alt="XSP" width="100"/>
        <nav><a href="index" class="overviewB "> <span class="pop">overview</span> </a> <a href="services"
                                                                                           class="servicesB"> <span
                class="pop">our services</span> </a> <a href="ways" class="ways"> <span class="pop">our ways</span> </a>
            <!--a href="about" class="about"> <span class="pop">about xsp</span> </a--> <a href="contact"
                                                                                           class="contact select"> <span
                    class="pop">contact us</span> </a></nav>
    </div>
</div>
<br>
                            ...
                            <div class="contactUs">
                                ...
                                <div class="unit">
                                    <form name="myform" id="myform" action="" method="POST">
                                        ...
                                        <input type="submit" class="button floatR clear clearWidth" name="submit"
                                               value="submit">
                                    </form>
                                </div>
                            </div>

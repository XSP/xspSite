...
<li><a target="_blank" href="http://facebook.com/<?php $options = get_option('evolve');if ($evl_facebook == "" ) $evl_facebook = $default_facebook;echo stripslashes($evl_facebook);?>" class="tipsytext" id="facebook" original-title="Facebook"></a></li><?php } else { ?><?php } ?>

<?php 
  if (!empty($evl_twitter_id)) { ?>
<li><a target="_blank" href="http://twitter.com/<?php $options = get_option('evolve');if ($evl_twitter_id == "" ) $evl_twitter_id = $default_twitter_id;echo stripslashes($evl_twitter_id);?>" style="text-decoration: none;" class="tipsytext" id="twitter" original-title="Twitter"></a></li><?php } else { ?><?php } ?>

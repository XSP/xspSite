<div class="wrapper">
    <div class="home">
        ...
        <p>XSP
            ...
            started as the joint operation between designer and developer. To encompass the proper user experience and
            functionality of any pretty things on the web, both designer and developer plays the major role to combine
            and
            build pretty things.
        </p>
    </div>
